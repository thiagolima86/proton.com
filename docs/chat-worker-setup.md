...
```json
{
  "reply": "O plano autônomo custa R$ 99/mês após o período de teste grátis de 7 dias grátis.",
  "fallback_whatsapp": false
}
```
...
Teste de contexto (resposta a "sim" deve continuar o teste grátis, não cumprimentar de novo):
